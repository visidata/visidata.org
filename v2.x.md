...
---
Please note, that there are two open bugs for defermods at the time of this release: https://github.com/saulpw/visidata/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+%5Bdefermods%5D. Subscribe to those issues to get updates on when they have been fixed.
---
...
#### 5. Default startup launches the VisiDataMenu

Previously, if a user launched `vd` without a source, the **DirSheet** for the current directory would pop up.

To aid in discovery of key sheets in VisiData a **vdmenu**, with an overview of them, is now launched when no sources are supplied.
